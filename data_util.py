...
def generate_batch(X, y, FLAGS, embedding):
    ...
    for batch_num in range(num_batches):
        ...
        if filler_type == "fixed_filler":
            ...
            elif FLAGS.experiment_name == "variablefiller_gensymbolicstates_100000_1_testunseen_QSubjectQFriend":
                FILLER_INDICES = [0, 5, 6, 13, 18, 19, 20, 21, 22, 23, 24, 25]
...
def shift_inputs(batchX, experiment_name):
    ...
    if experiment_name == "variablefiller_gensymbolicstates_100000_1_testunseen_QSubject":
        padding_index = 15
    elif experiment_name == "variablefiller_gensymbolicstates_100000_1_testunseen_QSubjectQFriend":
        padding_index = 15
        ...
        padding_index = 25
    elif experiment_name == "fixedfiller_gensymbolicstates_100000_1_testunseen_QSubject":
        padding_index = 24
    else:
