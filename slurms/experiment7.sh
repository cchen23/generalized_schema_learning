#!/usr/bin/env bash
#SBATCH -J 'statret'
#SBATCH -o outputs/slurm-%j-experiment7.out
#SBATCH -p all
#SBATCH -t 100
#SBATCH -N 1
...
## Generate stories.
#python -u /home/cc27/Thesis/generalized_schema_learning/experiment_creators/story_probestatisticsretention_generator.py 100
#python -u /home/cc27/Thesis/generalized_schema_learning/experiment_creators/story_probestatisticsretention_generator.py 75
#python -u /home/cc27/Thesis/generalized_schema_learning/experiment_creators/story_probestatisticsretention_generator.py 50
#python -u /home/cc27/Thesis/generalized_schema_learning/experiment_creators/story_probestatisticsretention_generator.py 25
#python -u /home/cc27/Thesis/generalized_schema_learning/experiment_creators/story_probestatisticsretention_generator.py 0
