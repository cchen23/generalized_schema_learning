...
python /home/cc27/Thesis/generalized_schema_learning/analysis/generate_accuracy_bargraphs_multitrials.py --exp_folder=variablefiller_gensymbolicstates_100000_1_testunseen_QSubject/variable_filler/ --exp_title="Variable Random Representation" --exp_title2="QSubject, Previously Unseen Fillers" --save="False" --split_queries="QDessert,QDrink,QEmcee,QFriend,QPoet,QSubject" --chance_rate=0.023 --epochs_dict='{"RNN-LN":3000, "LSTM-LN":3000, "RNN-LN-FW":3000, "NTM2":3000}' --trial_nums="[0,1,2]" # For bar charts.
