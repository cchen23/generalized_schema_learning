...
python /home/cc27/Thesis/generalized_schema_learning/analysis/generate_accuracy_bargraphs.py --exp_folder=fixedfiller_gensymbolicstates_100000_1_AllQs/fixed_filler/ --exp_title="Fixed Random Representation" --exp_title2="AllQs, Previously Seen Fillers" --trial_num=0 --chance_rate=0.023 --epochs_dict='{"RNN-LN":1000, "LSTM-LN":1000, "RNN-LN-FW":50, "NTM2":50}' # For bar charts.
python /home/cc27/Thesis/generalized_schema_learning/analysis/generate_accuracy_bargraphs.py --exp_folder=fixedfiller_gensymbolicstates_100000_1_AllQs/fixed_filler/ --exp_title="Fixed Random Representation" --exp_title2="AllQs, Previously Seen Fillers" --trial_num=1 --chance_rate=0.023 --epochs_dict='{"RNN-LN":1000, "LSTM-LN":1000, "RNN-LN-FW":50, "NTM2":50}' # For bar charts.
python /home/cc27/Thesis/generalized_schema_learning/analysis/generate_accuracy_bargraphs.py --exp_folder=fixedfiller_gensymbolicstates_100000_1_AllQs/fixed_filler/ --exp_title="Fixed Random Representation" --exp_title2="AllQs, Previously Seen Fillers" --trial_num=2 --chance_rate=0.023 --epochs_dict='{"RNN-LN":1000, "LSTM-LN":1000, "RNN-LN-FW":50, "NTM2":50}' # For bar charts.
echo "Done generating plots."
python /home/cc27/Thesis/generalized_schema_learning/analysis/generate_accuracy_bargraphs_multitrials.py --exp_folder=fixedfiller_gensymbolicstates_100000_1_AllQs/fixed_filler/ --exp_title="Fixed Random Representation" --exp_title2="AllQs, Previously Seen Fillers" --save="False" --chance_rate=0.023 --epochs_dict='{"RNN-LN":1000, "LSTM-LN":1000, "RNN-LN-FW":50, "NTM2":50}' --trial_nums="[0,1,2]" # For bar charts.
