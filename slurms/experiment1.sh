...
python /home/cc27/Thesis/generalized_schema_learning/analysis/generate_accuracy_plots.py --exp_folder=fixedfiller_gensymbolicstates_100000_1_AllQs/fixed_filler/ --exp_title="Fixed Representation" --exp_title2="AllQs, Previously Seen Fillers" --num_smooth=10 --trial_num=0 --split_queries="QDessert,QDrink,QEmcee,QFriend,QPoet,QSubject" --chance_rate=0.023 # For accuracy vs epochs.
python /home/cc27/Thesis/generalized_schema_learning/analysis/generate_accuracy_bargraphs_multitrials.py --exp_folder=fixedfiller_gensymbolicstates_100000_1_AllQs/fixed_filler/ --exp_title="Fixed Representation" --exp_title2="AllQs, Previously Seen Fillers" --save="True" --chance_rate=0.023 --epochs_dict='{"RNN-LN":1000, "LSTM-LN":1000, "RNN-LN-FW":50, "NTM2":50}' --trial_nums="[0,1,2]" # For bar charts.
