...
python /home/cc27/Thesis/generalized_schema_learning/analysis/generate_accuracy_plots.py --exp_folder=fixedfiller_gensymbolicstates_100000_1_AllQs/fixed_filler/ --exp_title="Fixed Random Representation" --exp_title2="AllQs, Previously Seen Fillers" --num_smooth=1 --trial_num=0 --split_queries="QDessert,QDrink,QEmcee,QFriend,QPoet,QSubject"
