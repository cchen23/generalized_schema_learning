...
#SBATCH -o outputs/slurm-%j-ntm2normembeddingtest.out
#SBATCH -p all
#SBATCH -t 1000
#SBATCH -N 1
#SBATCH --gres=gpu:1
...
python /home/cc27/Thesis/generalized_schema_learning/run_experiment.py --function=train --exp_name=variablefiller_gensymbolicstates_100000_1_testunseen_AllQs --filler_type=variable_filler --model_name=NTM2 --num_epochs=30000 --trial_num=6 --embedding_type=norm
