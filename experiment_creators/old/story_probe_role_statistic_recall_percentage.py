...
def generate_experiments(num_dims=50,
    ...
    distribution_A_fillers_train = list(np.random.choice(add_05_fillers_train, size=num_train_fillers_per_category * percentage // 100, replace=False)) + list(np.random.choice(subtract_05_fillers_train, size=num_train_fillers_per_category * (100 - percentage) // 100, replace=False))
    distribution_A_fillers_test = list(np.random.choice(add_05_fillers_test, size=num_test_fillers_per_category * percentage // 100, replace=False)) + list(np.random.choice(subtract_05_fillers_test, size=num_test_fillers_per_category * (100 - percentage) // 100, replace=False))
    distribution_B_fillers_train = list(np.random.choice(subtract_05_fillers_train, size=num_train_fillers_per_category * percentage // 100, replace=False)) + list(np.random.choice(add_05_fillers_train, size=num_train_fillers_per_category * (100 - percentage) // 100, replace=False))
    distribution_B_fillers_test = list(np.random.choice(subtract_05_fillers_test, size=num_test_fillers_per_category * percentage // 100, replace=False)) + list(np.random.choice(add_05_fillers_test, size=num_test_fillers_per_category * (100 - percentage) // 100, replace=False))
