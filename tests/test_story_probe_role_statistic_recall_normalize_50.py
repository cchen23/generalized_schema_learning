...
save_dir = os.path.join('/', 'home', 'cc27', 'Thesis', 'generalized_schema_learning', 'data', 'probe_role_statistic_recall_normalize_50')
...
def assert_distribution(fillers_list, term_a, term_a_proportion, term_b, term_b_proportion, tolerance=0.20):
...
def test_train_set():
    ...
    assert_distribution(subject_poet_answers, 'even', 0.50, 'odd', 0.50)
    assert_distribution(emcee_friend_answers, 'odd', 0.50, 'even', 0.50)
