...
save_dir = os.path.join('/', 'home', 'cc27', 'Thesis', 'generalized_schema_learning', 'data', 'probe_role_statistic_recall_normalize_100')
...
def assert_distribution(fillers_list, term_a, term_a_proportion, term_b, term_b_proportion, tolerance=0):
...
def test_train_set():
    ...
    assert_distribution(subject_poet_answers, 'add', 1, 'subtract', 0)
    assert_distribution(emcee_friend_answers, 'subtract', 1, 'add', 0)
...
def test_flipped_test_set():
    ...
    assert_distribution(subject_poet_answers, 'add', 0, 'subtract', 1)
    assert_distribution(emcee_friend_answers, 'subtract', 0, 'add', 1)
