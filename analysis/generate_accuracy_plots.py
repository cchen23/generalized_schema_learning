...
Create plots.
"""
def plot_data(data, plot_index, experiment_title, experiment_title2, num_smooth=1, legend=False, xlim=None, ylim=None, save=False, save_dir=None):
...
def plot_split_data(data, experiment_title, experiment_title2, num_smooth, split_queries, xlim=None, save=False, save_dir=None):
...
if __name__ == '__main__':
    ...
    plot_data(results, plot_index, experiment_title, experiment_title2, num_smooth, legend=legend, xlim=xlim, ylim=ylim, save=save, save_dir=save_dir)
    ...
    if split_queries:
        ...
        plot_split_data(results, experiment_title, experiment_title2, num_smooth, split_queries, xlim=xlim, save=save, save_dir=save_dir)
